    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action aboutInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Курочкин Антон, 6 группа", "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
...
// со значением по умолчанию 0.0
        textFieldFrom = new JTextField("-2.0", 10);
...
// со значением по умолчанию 1.0
        textFieldTo = new JTextField("2.0", 10);
        // Установить максимальный размер равный предпочтительному, чтобы
// предотвратить увеличение размера поля ввода
